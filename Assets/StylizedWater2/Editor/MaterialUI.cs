...
namespace StylizedWater2
{
    public partial class MaterialUI : ShaderGUI
    {
        ...
        private void OnEnable(MaterialEditor materialEditorIn)
        {
            ...
            LoadTextures("e378e2b546ee7b844b6a6ac07267550c", ref foamTextures);
            LoadTextures("23329bb54ffd1a54cac5500c316fecd4", ref normalMapTextures);

            initialized = true;
        }

        private void LoadTextures(string folderGUID, ref List<Texture2D> target)
        {
            ...
            for (int i = 0; i < fileInfo.Length; i++)
            {
                ...
                {
                    string path = fileInfo[i].FullName.Replace(dataPath, "Assets");
